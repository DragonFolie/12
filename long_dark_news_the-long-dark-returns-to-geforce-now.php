...
if(isset($_COOKIE["nickNameField"]) && $_COOKIE["nickNameField"] != "" && isset($_COOKIE["commentArea"]) && $_COOKIE["commentArea"] != "")
{
    ...
    VALUES ('$name', '$comment', '$date', '0', '0', '4');";
...
<main class="main">
    <div class="main_inner">
        <div class="main_inner_title_content">
            <img src="img/Nvidia-Banner-Site-Forum-1360x566-1-1.png" class="main_inner_title_photo" alt="season's greetings" srcset="">
        ...
        <div class="main_inner_main_content">
            ...
            <br>
            <div class="main_text">
                <p >I believe that creators must be the custodians of their own content, and that developers should be able to determine for themselves which platforms their games are experienced on. In fact, I strongly believe that the continued vibrancy of the independent games industry depends on us being masters of our own destiny</p><br>
                <p >
