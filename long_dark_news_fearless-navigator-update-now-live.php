...
<main class="main">
    <div class="main_inner">
        <div class="main_inner_title_content">
            <img src="img/Fearless-Navigator_Blog_Post_Cover_1360x566-comp-1024x426-1.jpg" class="main_inner_title_photo" alt="season's greetings" srcset="">
            <h1 class="main_inner_title">THE LONG DARK RETURNS TO GEFORCE NOW</h1>
            <span class="main_inner_date">28.05.2020.</span>
        ...
        <div class="main_inner_main_content">
            ...
            <div class="main_text">
                ...
                <p >
                    ...
                    <iframe width="940" height="519" src="https://www.youtube.com/embed/WBpMFegfykw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div></p>
                <br>
                <h2>
                ...
                <ul  type="disc">
                    ...
                    <li>[UI] When viewing the Rock Cache Notes in your Journal, the scroll bar will not scroll.</li>
                    <li>[UI] When viewing the Rock Cache Notes in your Journal, the edit button will appear, even if there are no notes to edit.</li>
                    <li>[Audio] Sometimes during a blizzard, ambient wind sounds may become muted.</li>
                    <li>Players on Mac may not be able to see Spray Paint markers on the map, when sprayed on the ground</li>
                    <li>Players are unable to edit Rock Cache notes when playing with a controller</li>
                ...
                <ul  type="disc">
                    ...
                    <li>[General] Fixed stuttering when looking towards Wolves, while in Milton.</li>
                    <li>[General] Fixed null exception that would occur when lighting the Pot Belly Stove.</li>
                    <li>[General] Bear sound effects no longer play when a carcass is removed from the world.</li>
                    <li>[General] Updated Steam Controller profile. </li>
                    <li>[General] Fixed an issue that prevented Players from being able to save or load their game if the save contained invalid data.</li>
                ...
                <ul type="disc">
                    <li>[Enviro] Numerous optimizations to improve performance.</li>
                    <li>[Enviro] Fixed numerous areas the player could become stuck in.</li>
                    <li>[Enviro] Fixed numerous areas the player could get outside of the intended play area.</li>
                    <li>[Enviro] Fixed numerous clipping and floating objects.</li>
                    <li>[Enviro] Performed various optimizations to avoid texture popping.</li>
                    <li>[Enviro] Added casting shadows to numerous trees.</li>
                    <li>[Enviro] Improvements to item placement system to reduce frequency of out of reach items.</li>
                    <li>[Enviro] Fixed many minor art bugs to improve general polish in Bleak Inlet region.</li>
                ...
                <ul type="disc">
                    <li>[WINTERMUTE] Completing an Episode 1 or Episode 2 Side Missions now displays a completion message. </li>
                    <li>[EPISODE THREE] Fixed an issue in the Mine exiting Pleasant Valley, where players would be repositioned after reloading a saved game.</li>
                    <li>[EPISODE THREE] Added missing foley to the second part of the Mine Tremor cinematic.</li>
                    <li>[EPISODE THREE] IDs are now removed from the Players inventory when completing the Fallen Star mission in Episode Three .</li>
                    <li>[EPISODE THREE] Removed access to Timberwolf Mountain from Pleasant Valley.</li>
                    <li>[EPISODE THREE] Fixed the spawn condition of the Revolver found in Molly’s basement.</li>
                ...
                <ul type="disc">
                   <li>[Survival] Fixed incorrect spawn rate for the Prepper Cache found in Pleasant Valley.</li>
                   <li>[Survival] All cabins now display smoke coming out of their chimney, when a fire is lit inside. </li>
                   <li>[Survival] When sleeping, the save file screenshot will now occur after the player transitions from sleep, instead of during the transition.</li>
                   <li>[Survival] Players can now place a Rifle on the gun rack found in the Hunting Lodge.</li>
                   <li>[Survival] Cancelling while drinking Coffee will now award the appropriate amount of progress to the “Straight to the Heart” Feat.</li>
                   <li>[Survival] Pre-Spawned campfires will no longer respawn, when loading a save where they were previously broken down.</li>
                   <li>[Saves] Implemented a check to force the Aurora to be enabled on Survival Mode save files created prior to the Aurora being enabled.</li>
